...
#%% Defined convLSTM block and the inception blocks
...
def fused_model():
    ...
    vh_conv_lstm = conv_lstm_module(vh_input,input_length=8,conv_filters=64,lstm_filters=64,kern1=4,kern2=3)
    vh_flt_conv_lstm = Flatten()(vh_conv_lstm)
    vh_inception = inception_module(vh_conv_lstm,conv_filters=64,kern1=4,kern2=3,kern3=2)
    vh_inception = inception_module(vh_inception,conv_filters=64,kern1=4,kern2=3,kern3=2)
    vh_inception = inception_module(vh_inception,conv_filters=64,kern1=4,kern2=3,kern3=2)
    vh_inception = inception_module(vh_inception,conv_filters=64,kern1=4,kern2=3,kern3=2)
    vh_inception = inception_module(vh_inception,conv_filters=64,kern1=4,kern2=3,kern3=2)
    vh_flt_inception = Flatten()(vh_inception)

    vv_input = Input(shape=(8,1))
    vv_conv_lstm = conv_lstm_module(vv_input,input_length=8,conv_filters=64,lstm_filters=64,kern1=4,kern2=3)
    vv_flt_conv_lstm = Flatten()(vv_conv_lstm)
    vv_inception = inception_module(vv_conv_lstm,conv_filters=64,kern1=4,kern2=3,kern3=2)
    vv_inception = inception_module(vv_inception,conv_filters=64,kern1=4,kern2=3,kern3=2)
    vv_inception = inception_module(vv_inception,conv_filters=64,kern1=4,kern2=3,kern3=2)
    vv_inception = inception_module(vv_inception,conv_filters=64,kern1=4,kern2=3,kern3=2)
    vv_inception = inception_module(vv_inception,conv_filters=64,kern1=4,kern2=3,kern3=2)
    ...
    mss_conv_lstm = conv_lstm_module(mss_input,input_length=8,conv_filters=64,lstm_filters=64,kern1=4,kern2=3)
    mss_flt_conv_lstm = Flatten()(mss_conv_lstm)
    mss_inception = inception_module(mss_conv_lstm,conv_filters=64,kern1=4,kern2=3,kern3=2)
    mss_inception = inception_module(mss_inception,conv_filters=64,kern1=4,kern2=3,kern3=2)
    mss_inception = inception_module(mss_inception,conv_filters=64,kern1=4,kern2=3,kern3=2)
    mss_inception = inception_module(mss_inception,conv_filters=64,kern1=4,kern2=3,kern3=2)
    mss_inception = inception_module(mss_inception,conv_filters=64,kern1=4,kern2=3,kern3=2)
...
def sar_model():
    ...
    concat_inputs = concatenate([vh_flt_conv_lstm,vv_flt_conv_lstm,
                                 vh_flt_inception,vv_flt_inception])
    hidden1 = Dense(64, activation='relu')(concat_inputs)
    hidden2 = Dense(32, activation='relu')(hidden1)
    final_output = Dense(13, activation='softmax')(hidden2)
    final_model = Model(inputs=[vh_input,vv_input],outputs=final_output)
    adam_optimizer = Adam(learning_rate=0.0001)
    final_model.compile(loss='sparse_categorical_crossentropy', optimizer=adam_optimizer, metrics=['accuracy'])
    return final_model
